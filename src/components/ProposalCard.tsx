...
export function ProposalCard({
  ...
  const hasVoted =
    proposal.votesFor.includes(userAddress) ||
    proposal.votesAgainst.includes(userAddress);
        ...
        <CardContent className="p-8">
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              ...
              <p className="font-semibold text-gray-600 mb-4 text-lg">
                {proposal.description}
              </p>
              <div className="flex flex-wrap items-center gap-4">
                <div className="px-4 py-2 bg-white/60 backdrop-blur-sm rounded-xl border border-white/50">
                  <span className="text-sm text-gray-500">Monto: </span>
                  <span className="text-lg bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent">
                    ${proposal.amount}
                  </span>
                </div>
