...
import { Wallet, Users, Shield, Zap, Sparkles, Heart, CheckCircle } from 'lucide-react';
      ...
      <header className="relative border-b border-white/20 backdrop-blur-sm bg-white/30 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-2xl bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent">cooperacha</span>
        ...
        <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-blue-200/50 shadow-lg">
              ...
              <span className="text-sm text-blue-900">Plataforma descentralizada y segura</span>
            </div>
            ...
            <div className="space-y-6">
              <h1 className="text-6xl font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 bg-clip-text text-transparent leading-tight">
                Tu familia, tu ahorro,<br />tu control
              </h1>
              <p className="text-2xl font-semibold text-gray-700 leading-relaxed">
                Crea billeteras comunitarias, aporta junto a tu familia y toma decisiones democráticas con votación en blockchain.
              </p>
            </div>
            ...
            <div className="pt-8 space-y-4">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span>Conectar con Web3Auth</span>
                  <Sparkles className="w-5 h-5 group-hover:rotate-12 transition-transform" />
                </div>
              </Button>
              <p className="text-sm text-gray-600 flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                Sin contraseñas • Completamente descentralizado • Gastos compartidos
              </p>
            </div>
          </div>
            ...
            <div className="absolute top-0 right-0 animate-float">
              <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl border border-white/50 shadow-2xl shadow-blue-500/20 w-80">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Familia García</p>
                    <p className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent">$1,250.00</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-xs text-gray-700 ring-4 ring-white -ml-3">+1</div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white/80 backdrop-blur-xl p-6 rounded-3xl border border-white/50 shadow-2xl shadow-emerald-500/20 w-96">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-green-600">Propuesta Aprobada</p>
                    <p className="font-semibold text-gray-900">Medicamentos abuelos</p>
                  </div>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    {[1,2,3,4,5].map(i => (
                      <div key={i} className="flex-1 h-1 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full"></div>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <div className="absolute top-40 left-10 animate-float-slow">
              <div className="bg-white/80 backdrop-blur-xl p-6 rounded-2xl border border-white/50 shadow-xl shadow-cyan-500/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Ahorrado este mes</p>
...
function FeatureItem({ icon, title, description, gradient }: { icon: React.ReactNode; title: string; description: string; gradient: string }) {
  return (
    <div className="group flex gap-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/50 hover:bg-white/80 transition-all hover:scale-105 hover:shadow-xl cursor-pointer">
      <div className={`flex-shrink-0 w-14 h-14 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform`}>
        {icon}
      </div>
      <div>
